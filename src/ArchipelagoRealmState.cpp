...
void ArchipelagoRealmState::Load()
{
    ...
    LOG_INFO("module.archipelago_wow", "Archipelago: realm state loaded (level_cap={}, dark_portal={}, northrend_passage={}, unlocked_instances={})",
        _levelCap, _darkPortalUnlocked, _northrendPassageUnlocked, _unlockedInstances.size());
}
