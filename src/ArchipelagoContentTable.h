...
namespace Archipelago::Content
{
    ...
    inline std::unordered_map<int64_t, uint32_t> const ApItemIdToWowItemEntry = {
        ...
        { 800006, 43 }, // "Squire's Boots"
        { 800007, 45 }, // "Squire's Shirt"
        { 800008, 47 }, // "Footpad's Shoes"
        { 800009, 49 }, // "Footpad's Shirt"
        { 800010, 51 }, // "Neophyte's Boots"
        { 800011, 53 }, // "Neophyte's Shirt"
        { 800012, 55 }, // "Apprentice's Boots"
        { 800013, 59 }, // "Acolyte's Shoes"
        { 800014, 60 }, // "Layered Tunic"
        { 800015, 61 }, // "Dwarven Leather Pants"
        { 800016, 79 }, // "Dwarven Cloth Britches"
        { 800017, 80 }, // "Soft Fur-lined Shoes"
        { 800018, 85 }, // "Dirty Leather Vest"
    };
}
