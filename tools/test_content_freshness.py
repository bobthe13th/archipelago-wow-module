...
# M4.10.2: containersanity's regenerated Python file was intentionally written
...
# family is unaffected and keeps using _ARCHIPELAGO_WOW_DIR directly. This is
# the same worktree-escape-hatch pattern used (and then removed once merged)
# for M4.10.1's containersanity worktree -- see the nested submodule bump
